...
class BoxNet(models.Model):
    def __init__(self, width, depth, num_anchors=9, separable_conv=True, detect_quadrangle=False, **kwargs):
...
def efficientdet(phi, num_classes=20, num_anchors=9, weighted_bifpn=False,
